                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input type="text" value={paymentForm.cardNumber}
                        ...
                        className={`input-base ${errors.cardNumber ? 'border-tm-red' : ''}`} />
                      {errors.cardNumber && <p className="text-xs text-tm-red mt-1">{errors.cardNumber}</p>}
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="block text-xs font-sans font-bold uppercase tracking-widest mb-1.5">Expiry</label>
                      ...
                      <div>
                        <label className="block text-xs font-sans font-bold uppercase tracking-widest mb-1.5">CVV</label>
                        <input type="text" value={paymentForm.cvv}
                          onChange={(e) => setPaymentForm({ ...paymentForm, cvv: e.target.value.replace(/\D/g, '').slice(0, 4) })}
                          placeholder="123" maxLength={4}
                          className={`input-base ${errors.cvv ? 'border-tm-red' : ''}`} />
                  ...
                  <div className="flex gap-3 mt-6">
                    ...
                    <button onClick={handleCardPayment} disabled={loading}
                      ...
                      {loading
                        ...
                        : <><CreditCard className="w-4 h-4" /> Place Order — {formatPrice(grandTotal)}</>
                      }
                    </button>
                  </div>
                </div>
