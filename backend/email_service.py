...
def send_otp_email(to_email: str, user_name: str, otp_code: str) -> bool:
    ...
    try:
        ...
        msg["Subject"] = "Your TaylorMade Shop Verification Code"
        msg["From"] = f"TaylorMade Golf Shop <{SMTP_EMAIL}>"
        msg["To"] = to_email
...
<body>
  <div class="container">
    <div class="header">
      <h1>Taylor<span>Made</span> Golf</h1>
    </div>
    <div class="body">
      <h2>Hi {user_name},</h2>
      <p>Welcome to TaylorMade Golf Shop! Please verify your email address using the code below to complete your registration.</p>
      <div class="otp-box">
    ...
    <div class="footer">
      <p>© 2024 TaylorMade Golf Shop. All rights reserved.</p>
    </div>
  </div>
</body>
</html>
